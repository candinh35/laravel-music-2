                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <strong>WELCOME TO SPOTIFY SHOPEE!</strong>
                                                            </h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; ">
                                                                Hi {{ $data['name'] }}<br />Welcome to our website, hope
                                                                you will enjoy it.</h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: right; word-wrap: break-word; font-size: 16px; ">
                                                                Spotify Shopee</h1>
