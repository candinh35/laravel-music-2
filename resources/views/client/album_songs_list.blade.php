        ...
        <div class="col-lg-12">
            <div class="iq-card">
                <div class="iq-card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <img src="{{ asset('uploads/images/' . $album->image_path) }}" class="img-fluid w-100"
                                alt="">
                        </div>
                        <div class="col-lg-8">
                            <div class="d-flex align-items-top justify-content-between iq-music-play-detail">
                                <div class="music-detail">
                                    <h3>{{ $album->name }}</h3>
                                    {{-- <span>{{ $album->singer->name }}</span> --}}
                                    <p>Song · {{ count($album->songs) }} Plays</p>
                                    <div class="d-flex align-items-center">
                                        <button onclick="playTrack()" class="btn btn-primary iq-play mr-2">Play
                                            music</button>
                                    </div>
                                </div>
